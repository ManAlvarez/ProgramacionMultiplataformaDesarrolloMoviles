...
public class AdminSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    /**
     * Método para actualizar los registros del perfil sel usuario
     *
     * @param idUser
     * @param nombre
     * @param apellidos
    ...
    public void updatearPerfilUsuario(int idUser, String nombre, String apellidos, String eMail, String pass, String tipo) {
        ContentValues values = new ContentValues();
        values.put("nombre", nombre);
        values.put("apellidos", apellidos);
        values.put("email", eMail);
        values.put("contrasenha", pass);
        values.put("tipo", tipo);
        this.getWritableDatabase().update("usuarios", values, "id_usuario = " + idUser, null);
    }
